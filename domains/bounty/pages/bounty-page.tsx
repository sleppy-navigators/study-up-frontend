...
import { TaskSection } from '@/domains/bounty/components/task-section';
import type { TaskItemProps } from '@/domains/bounty/components/task-item';
import { ListSection } from '@/domains/base/components/list-section';
import type { ListItemProps } from '@/domains/base/components/list-item';
...
export function BountyPage() {
  ...
  return (
    <YStack flex={1} backgroundColor="$background">
      <ScrollView flex={1}>
        <ListSection title="바운티" items={bountyItems} />
