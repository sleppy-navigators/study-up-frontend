...
} from '@/domains/base/components/header';
import {
  useGroupChallengesQuery,
  useGroupTasksQuery,
} from '@/domains/group/api';
import { GroupChallengeListItem } from '@/domains/group/api/types';
import { TaskSection } from '@/domains/group/components/task-section';
import { ChallengeSection } from '@/domains/group/components/challenge-section';
import { InvitationBottomSheet } from '@/domains/group/components/invitation-bottom-sheet';
