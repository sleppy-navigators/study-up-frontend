...
import { GroupSection } from '@/domains/group/components/group-section';
import type { GroupItemProps } from '@/domains/group/components/group-item';
import { useUserGroupsQuery } from '@/domains/user/api';
